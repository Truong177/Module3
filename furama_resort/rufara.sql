...
-- Hiển thị thông tin của tất cả khách hàng có độ tuổi từ 18 đến 50 tuổi và có
-- địa chỉ ở “Đà Nẵng” hoặc “Quảng Trị”.
select * from khach_hang
where datediff(current_date(), ngay_sinh)/365 between 18 and 50
and (dia_chi like '%Đà Nẵng%' or dia_chi like '%Quảng Trị%');
-- Đếm xem tương ứng với mỗi khách hàng đã từng đặt phòng bao nhiêu lần.
-- Kết quả hiển thị được sắp xếp tăng dần theo số lần đặt phòng của khách
-- hàng. Chỉ đếm những khách hàng nào có  Tên   loại   khách   hàng   là
-- “Diamond”.
...
join (
    select kh1.ma_khach_hang
    from khach_hang kh1
    join hop_dong hd on kh1.ma_khach_hang = hd.ma_khach_hang
    where kh1.ten_loai_khach = 'Platinium'
    and year(hd.ngay_lam_hop_dong) = 2021
    group by kh1.ma_khach_hang
    having sum(hd.tong_tien) > 10000000
) kh_update on kh.ma_khach_hang = kh_update.ma_khach_hang
set kh.ten_loai_khach = 'Diamond';
